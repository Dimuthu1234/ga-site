        ...
        <div id="slideshow" class="header-slider" data-speed="4000" data-mobileslider="responsive" style="margin-top: -10%">
            <div class="slides-container">
                ...
                <div class="slide-item slide-item-2"
                     style="background-image:url({{ url('/images/DSC_0860.JPG') }});">
                    <img class="mobile-slide preserve"
                ...
                <div class="slide-item slide-item-5"
                     style="background-image:url({{ url('/images/DSC_0808.JPG') }});">
                    <img class="mobile-slide preserve"
                         src="{{ url('/images/DSC_0882.JPG') }}"
                         alt="Blavatnik@Trevor Palin"/>
                    <div class="slide-inner">
                        <div class="contain animated fadeInRightBig text-slider">
                            <h2 class="maintitle"></h2>
                                                                    ...
                                                                    <div data-id="6fe70da"
                                                                        ...
                                                                        <div class="elementor-widget-container">
                                                                            <div class="elementor-text-editor elementor-clearfix">
                                                                                <p>From its inception GA has
                                                                                    successfully completed projects both
                                                                                    in the UK and overseas. Early on in
                                                                                    our career we undertook the
                                                                                    Lufthansa Centre in Beijing and
                                                                                    since then have carried out projects
                                                                                    in Germany, Sweden, Azerbaijan, and
                                                                                    Ireland to name but a few.
                                                                                    In 2012 GA entered the Middle
                                                                                    Eastern Market; demand for our
                                                                                    services escalated very quickly
                                                                                    resulting in us deciding to
                                                                                    establish a presence in Doha. GAI
                                                                                    Qatar was incorporated in 2012 and
                                                                                    runs as a separate company
                                                                                    exclusively for the middle eastern
                                                                                    market but does utilise the
                                                                                    knowledge base of GAIM in the UK
                                                                                    whenever it needs.
                                                                                </p></div>
                                                                        </div>
                                                                    </div>
                                                                            ...
                                                                            <div class="elementor-image-carousel-wrapper elementor-slick-slider"
                                                                                ...
                                                                                <div class="elementor-image-carousel slick-arrows-inside">
                                                                                    ...
                                                                                    <div class="slick-slide">
                                                                                        <figure class="slick-slide-inner">
                                                                                            <img class="slick-slide-image"
                                                                                                 src="{{ url('/images/Pearl Palace_edited-1.jpg') }}"
                                                                                                 alt="Versatile Installation"/>
                                                                                        </figure>
                                                                                    </div>
                                                                                </div>
                ...
                <span class="elementor-icon elementor-animation-shrink">
                    <i class="fa fa-building"></i>
                                                                                ...
                                                                                <div class="elementor-icon-box-content">
                                                                                    ...
                                                                                    <p class="elementor-icon-box-description">
                                                                                        Completed projects in Doha
                                                                                        include Qatar Petroleum
                                                                                        District; Lusail Mix; TJ Pearl
                                                                                        Mansions and Harvey Nicholls. In
                                                                                        addition we are just finishing
                                                                                        the completion of the passenger
                                                                                        terminals for the Passenger
                                                                                        Movement System – the first rail
                                                                                        system in Qatar.</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                ...
                <span class="elementor-icon elementor-animation-shrink">
                    <i class="fa fa-building-o"></i>
                                                                                ...
                                                                                <div class="elementor-icon-box-content">
                                                                                    ...
                                                                                    <p class="elementor-icon-box-description">
                                                                                        GAI Qatar are proud to be
                                                                                        involved in two of the world Cup
                                                                                        stadiums being prepared for FIFA
                                                                                        2022. Installation of the roof
                                                                                        at The Zaha Hadid designed
                                                                                        Al-Wakrah stadium has just
                                                                                        commenced and the beautifully
                                                                                        designed roof of the Thumama
                                                                                        Stadium will begin in the Autumn
                                                                                        of 2018.</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div data-id="c6a6314" style="margin-top: 23%"
